...
## [Introduction](https://ziglang.org/documentation/master/#toc-Introduction) [§](https://ziglang.org/documentation/master/#Introduction)
...
## [Hello World](https://ziglang.org/documentation/master/#toc-Hello-World) [§](https://ziglang.org/documentation/master/#Hello-World)
...
-   [Values](https://ziglang.org/documentation/master/#Values)

-   [Tuples](https://ziglang.org/documentation/master/#Tuples)
-   [@import](https://ziglang.org/documentation/master/#import)

-   [Errors](https://ziglang.org/documentation/master/#Errors)
-   [Entry Point](https://ziglang.org/documentation/master/#Entry-Point)

-   [Source Encoding](https://ziglang.org/documentation/master/#Source-Encoding)
-   [try](https://ziglang.org/documentation/master/#try)

## [Comments](https://ziglang.org/documentation/master/#toc-Comments) [§](https://ziglang.org/documentation/master/#Comments)
...
/home/ci/zig-bootstrap/zig/doc/langref/invalid\_doc-comment.zig:1:16: error: expected type expression, found 'a document comment'
/// doc-comment
               ^
...
/home/ci/zig-bootstrap/zig/doc/langref/unattached\_doc-comment.zig:3:1: error: unattached documentation comment
/// End of file
^~~~~~~~~~~~~~~
...
## [Values](https://ziglang.org/documentation/master/#toc-Values) [§](https://ziglang.org/documentation/master/#Values)
...
Only allowed for [comptime](https://ziglang.org/documentation/master/#comptime)\-known values. The type of integer literals.

`comptime_float`

(none)

Only allowed for [comptime](https://ziglang.org/documentation/master/#comptime)\-known values. The type of float literals.
...
-   [Errors](https://ziglang.org/documentation/master/#Errors)
-   [@Int](https://ziglang.org/documentation/master/#Int)
...
/home/ci/zig-bootstrap/zig/doc/langref/constant\_identifier\_cannot\_change.zig:8:5: error: cannot assign to constant
    y += 1;
    ^
referenced by:
    main: /home/ci/zig-bootstrap/zig/doc/langref/constant\_identifier\_cannot\_change.zig:12:8
    callMain \[inlined\]: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59
    callMainWithArgs \[inlined\]: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:626:20
    posixCallMainAndExit: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:581:38
...
/home/ci/zig-bootstrap/zig/doc/langref/var\_must\_be\_initialized.zig:2:15: error: expected '=', found ';'
    var x: i32;
              ^

#### [undefined](https://ziglang.org/documentation/master/#toc-undefined) [§](https://ziglang.org/documentation/master/#undefined)
...
In [Debug](https://ziglang.org/documentation/master/#Debug) and [ReleaseSafe](https://ziglang.org/documentation/master/#ReleaseSafe) mode, Zig writes `0xaa` bytes to undefined memory. This is to catch bugs early, and to help detect use of undefined memory in a debugger. However, this behavior is only an implementation feature, not a language semantic, so it is not guaranteed to be observable to code.
...
## [Zig Test](https://ziglang.org/documentation/master/#toc-Zig-Test) [§](https://ziglang.org/documentation/master/#Zig-Test)
...
The `testing_introduction.zig` code sample tests the [function](https://ziglang.org/documentation/master/#Functions) `addOne` to ensure that it returns `42` given the input `41`. From this test's perspective, the `addOne` function is said to be *code under test*.

zig test is a tool that creates and runs a test build. By default, it builds and runs an executable program using the *default test runner* provided by the [Zig Standard Library](https://ziglang.org/documentation/master/#Zig-Standard-Library) as its main entry point. During the build, `test` declarations found while [resolving](https://ziglang.org/documentation/master/#File-and-Declaration-Discovery) the given Zig source file are included for the default test runner to run and report on.
...
Test declarations are similar to [Functions](https://ziglang.org/documentation/master/#Functions): they have a return type and a block of code. The implicit return type of `test` is the [Error Union Type](https://ziglang.org/documentation/master/#Error-Union-Type) `anyerror!void`, and it cannot be changed. When a Zig source file is not built using the zig test tool, the test declarations are omitted from the build.
...
Test declarations named using an identifier are *doctests*. The identifier must refer to another declaration in scope. A doctest, like a [doc comment](https://ziglang.org/documentation/master/#Doc-Comments), serves as documentation for the associated declaration, and will appear in the generated documentation for the declaration.
...
/home/ci/zig-bootstrap/out/host/lib/zig/std/testing.zig:612:14: 0x1022019 in expect (std.zig)
    if (!ok) return error.TestUnexpectedResult;
             ^
/home/ci/zig-bootstrap/zig/doc/langref/testing\_failure.zig:4:5: 0x102208e in test.expect this to fail (testing\_failure.zig)
    try std.testing.expect(false);
    ^
2/2 testing\_failure.test.expect this to succeed...OK
1 passed; 0 skipped; 1 failed.
error: the following test command failed with exit code 1:
/home/ci/zig-bootstrap/out/zig-local-cache/o/d49a5b4552e009f74da5f67ac6f55346/test --seed=0xef805635
...
\[DebugAllocator\] (err): memory address 0x7f2159c80000 leaked:
/home/ci/zig-bootstrap/out/host/lib/zig/std/array\_list.zig:1190:56: 0x1086307 in ensureTotalCapacityPrecise (std.zig)
                const new\_memory = try gpa.alignedAlloc(T, alignment, new\_capacity);
                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/array\_list.zig:1166:51: 0x1059d59 in ensureTotalCapacity (std.zig)
            return self.ensureTotalCapacityPrecise(gpa, growCapacity(new\_capacity));
                                                  ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/array\_list.zig:1220:41: 0x1030c0d in addOne (std.zig)
            try self.ensureTotalCapacity(gpa, newlen);
                                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/array\_list.zig:893:49: 0x102ae97 in append (std.zig)
            const new\_item\_ptr = try self.addOne(gpa);
                                                ^
/home/ci/zig-bootstrap/zig/doc/langref/testing\_detect\_leak.zig:7:20: 0x1028091 in test.detect leak (testing\_detect\_leak.zig)
    try list.append(gpa, '☔');
                   ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11bf7e7 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11bc2a2 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b89c2 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b83f1 in \_start (std.zig)
...
error: the following test command failed with exit code 1:
/home/ci/zig-bootstrap/out/zig-local-cache/o/0abcb98c8479cbdd679c1c2c691e4aa8/test --seed=0x54f71580
...
## [Variables](https://ziglang.org/documentation/master/#toc-Variables) [§](https://ziglang.org/documentation/master/#Variables)

A variable is a unit of [Memory](https://ziglang.org/documentation/master/#Memory) storage.
...
The `extern` keyword or [@extern](https://ziglang.org/documentation/master/#extern) builtin function can be used to link against a variable that is exported from another object. The `export` keyword or [@export](https://ziglang.org/documentation/master/#export) builtin function can be used to make a variable available to other objects at link time. In both cases, the type of the variable must be C ABI compatible.
...
For [Single Threaded Builds](https://ziglang.org/documentation/master/#Single-Threaded-Builds), all thread local variables are treated as regular [Container Level Variables](https://ziglang.org/documentation/master/#Container-Level-Variables).
...
## [Integers](https://ziglang.org/documentation/master/#toc-Integers) [§](https://ziglang.org/documentation/master/#Integers)
...
Operators such as `+` and `-` cause [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior) on integer overflow. Alternative operators are provided for wrapping and saturating arithmetic on all targets. `+%` and `-%` perform wrapping arithmetic while `+|` and `-|` perform saturating arithmetic.
...
## [Floats](https://ziglang.org/documentation/master/#toc-Floats) [§](https://ziglang.org/documentation/master/#Floats)
...
## [Operators](https://ziglang.org/documentation/master/#toc-Operators) [§](https://ziglang.org/documentation/master/#Operators)
...
-   Signed integer operands must be comptime-known and positive. In other cases, use [@divTrunc](https://ziglang.org/documentation/master/#divTrunc), [@divFloor](https://ziglang.org/documentation/master/#divFloor), or [@divExact](https://ziglang.org/documentation/master/#divExact) instead.
-   Invokes [Peer Type Resolution](https://ziglang.org/documentation/master/#Peer-Type-Resolution) for the operands.
...
-   Can cause [Division by Zero](https://ziglang.org/documentation/master/#Division-by-Zero) for floats in [FloatMode.Optimized Mode](https://ziglang.org/documentation/master/#Floating-Point-Operations).
-   Signed or floating-point operands must be comptime-known and positive. In other cases, use [@rem](https://ziglang.org/documentation/master/#rem) or [@mod](https://ziglang.org/documentation/master/#mod) instead.
...
Returns `true` if a is greater than b, otherwise returns `false`. Invokes [Peer Type Resolution](https://ziglang.org/documentation/master/#Peer-Type-Resolution) for the operands.
...
## [Arrays](https://ziglang.org/documentation/master/#toc-Arrays) [§](https://ziglang.org/documentation/master/#Arrays)
...
-   [for](https://ziglang.org/documentation/master/#for)
...
## [Vectors](https://ziglang.org/documentation/master/#toc-Vectors) [§](https://ziglang.org/documentation/master/#Vectors)
...
It is prohibited to use a math operator on a mixture of scalars (individual numbers) and vectors. Zig provides the [@splat](https://ziglang.org/documentation/master/#splat) builtin to easily convert from scalars to vectors, and it supports [@reduce](https://ziglang.org/documentation/master/#reduce) and array indexing syntax to convert from vectors to scalars. Vectors also support assignment to and from fixed-length arrays with comptime-known length.

For rearranging elements within and between vectors, Zig provides the [@shuffle](https://ziglang.org/documentation/master/#shuffle) and [@select](https://ziglang.org/documentation/master/#select) functions.
...
-   [@splat](https://ziglang.org/documentation/master/#splat)

-   [@shuffle](https://ziglang.org/documentation/master/#shuffle)
-   [@select](https://ziglang.org/documentation/master/#select)

-   [@reduce](https://ziglang.org/documentation/master/#reduce)

### [Relationship with Arrays](https://ziglang.org/documentation/master/#toc-Relationship-with-Arrays) [§](https://ziglang.org/documentation/master/#Relationship-with-Arrays)

Vectors and [Arrays](https://ziglang.org/documentation/master/#Arrays) each have a well-defined **bit layout** and therefore support [@bitCast](https://ziglang.org/documentation/master/#bitCast) between each other. [Type Coercion](https://ziglang.org/documentation/master/#Type-Coercion) implicitly peforms `@bitCast`.

Arrays have well-defined byte layout, but vectors do not, making [@ptrCast](https://ziglang.org/documentation/master/#ptrCast) between them [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior).
...
## [Pointers](https://ziglang.org/documentation/master/#toc-Pointers) [§](https://ziglang.org/documentation/master/#Pointers)
...
-   `[*]T` - many-item pointer to unknown number of items.
    ...
    `T` must have a known size, which means that it cannot be `anyopaque` or any other [opaque type](https://ziglang.org/documentation/master/#opaque).
...
In Zig, we generally prefer [Slices](https://ziglang.org/documentation/master/#Slices) rather than [Sentinel-Terminated Pointers](https://ziglang.org/documentation/master/#Sentinel-Terminated-Pointers). You can turn an array or pointer into a slice using slice syntax.
...
-   [Optional Pointers](https://ziglang.org/documentation/master/#Optional-Pointers)

-   [@ptrFromInt](https://ziglang.org/documentation/master/#ptrFromInt)
-   [@intFromPtr](https://ziglang.org/documentation/master/#intFromPtr)
...
If you have a pointer or a slice that has a small alignment, but you know that it actually has a bigger alignment, use [@alignCast](https://ziglang.org/documentation/master/#alignCast) to change the pointer into a more aligned pointer. This is a no-op at runtime, but inserts a [safety check](https://ziglang.org/documentation/master/#Incorrect-Pointer-Alignment):
...
1/1 test\_incorrect\_pointer\_alignment.test.pointer alignment safety...thread 790762 panic: incorrect alignment
/home/ci/zig-bootstrap/zig/doc/langref/test\_incorrect\_pointer\_alignment.zig:10:68: 0x10361f6 in foo (test\_incorrect\_pointer\_alignment.zig)
    const int\_slice = std.mem.bytesAsSlice(u32, @as(\[\]align(4) u8, @alignCast(slice4)));
                                                                   ^
/home/ci/zig-bootstrap/zig/doc/langref/test\_incorrect\_pointer\_alignment.zig:6:31: 0x103608e in test.pointer alignment safety (test\_incorrect\_pointer\_alignment.zig)
    try std.testing.expect(foo(bytes) == 0x11111111);
                              ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c0317 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11ba122 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b6842 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b6271 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/de72d6fc0af3dbc6eeb006a5bbaea502/test --seed=0x98b9eac1
...
/home/ci/zig-bootstrap/zig/doc/langref/sentinel-terminated\_pointer.zig:11:16: error: expected type '\[\*:0\]const u8', found '\*const \[14\]u8'
    \_ = printf(&non\_null\_terminated\_msg);
               ^~~~~~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/sentinel-terminated\_pointer.zig:11:16: note: destination pointer requires '0' sentinel
/home/ci/zig-bootstrap/zig/doc/langref/sentinel-terminated\_pointer.zig:4:34: note: parameter type declared here
pub extern "c" fn printf(format: \[\*:0\]const u8, ...) c\_int;
                                 ^~~~~~~~~~~~~
referenced by:
    callMain \[inlined\]: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59
    callMainWithArgs \[inlined\]: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:626:20
    main: /home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:652:28
...
## [Slices](https://ziglang.org/documentation/master/#toc-Slices) [§](https://ziglang.org/documentation/master/#Slices)
...
1/1 test\_basic\_slices.test.basic slices...thread 788498 panic: index out of bounds: index 10, len 4
/home/ci/zig-bootstrap/zig/doc/langref/test\_basic\_slices.zig:41:10: 0x103812a in test.basic slices (test\_basic\_slices.zig)
    slice\[10\] += 1;
         ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c4177 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11bdf82 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11ba6a2 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11ba0d1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/109fd67901bdb954065bb7e3e34d9189/test --seed=0xf8c9cb06
...
1/1 test\_sentinel\_mismatch.test.sentinel mismatch...thread 788139 panic: sentinel mismatch: expected 0, found 1
/home/ci/zig-bootstrap/zig/doc/langref/test\_sentinel\_mismatch.zig:13:24: 0x10360af in test.sentinel mismatch (test\_sentinel\_mismatch.zig)
    const slice = array\[0..runtime\_length :0\];
                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c0167 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11b9f72 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b6692 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b60c1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/cb03bcfdbf563be560b8b916de67473d/test --seed=0x3f7e57b1
...
## [struct](https://ziglang.org/documentation/master/#toc-struct) [§](https://ziglang.org/documentation/master/#struct)
...
$ ./bad\_default\_value
thread 791168 panic: reached unreachable code
/home/ci/zig-bootstrap/out/host/lib/zig/std/debug.zig:419:14: 0x1031679 in assert (std.zig)
    if (!ok) unreachable; // assertion failure
             ^
/home/ci/zig-bootstrap/zig/doc/langref/bad\_default\_value.zig:8:15: 0x11a2e7a in categorize (bad\_default\_value.zig)
        assert(t.maximum >= t.minimum);
              ^
/home/ci/zig-bootstrap/zig/doc/langref/bad\_default\_value.zig:19:42: 0x11a1efe in main (bad\_default\_value.zig)
    const category = threshold.categorize(0.90);
                                         ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a24b8 in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
                                                          ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11a1eb1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
...
-   An [enum](https://ziglang.org/documentation/master/#enum) field uses exactly the bit width of its integer tag type.
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_missized\_packed\_struct.zig:2:29: error: backing integer type 'u32' has bit size 32 but the struct fields have a total bit size of 24
    const S = packed struct(u32) { a: u16, b: u8 };
                            ^~~
referenced by:
    test.missized packed struct: /home/ci/zig-bootstrap/zig/doc/langref/test\_missized\_packed\_struct.zig:2:22
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_misaligned\_pointer.zig:17:20: error: expected type '\*const u3', found '\*align(1:3:1) u3'
    try expect(bar(&bit\_field.b) == 2);
                   ^~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_misaligned\_pointer.zig:17:20: note: pointer host size '1' cannot cast into pointer host size '0'
/home/ci/zig-bootstrap/zig/doc/langref/test\_misaligned\_pointer.zig:17:20: note: pointer bit offset '3' cannot cast into pointer bit offset '0'
/home/ci/zig-bootstrap/zig/doc/langref/test\_misaligned\_pointer.zig:20:11: note: parameter type declared here
fn bar(x: \*const u3) u3 {
          ^~~~~~~~~
...
Field access and assignment can be understood as shorthand for bitshifts on the backing integer. These operations are not [atomic](https://ziglang.org/documentation/master/#Atomics), so beware using field access syntax when combined with memory-mapped input-output (MMIO). Instead of field access on [volatile](https://ziglang.org/documentation/master/#volatile) [Pointers](https://ziglang.org/documentation/master/#Pointers), construct a fully-formed new value first, then write that value to the volatile pointer.
...
anonymous: struct\_name.main\_\_struct\_29784
...
The struct type can be inferred. Here the [result location](https://ziglang.org/documentation/master/#Result-Location-Semantics) does not include a type, and so Zig infers the type:
...
## [enum](https://ziglang.org/documentation/master/#toc-enum) [§](https://ziglang.org/documentation/master/#enum)
...
/home/ci/zig-bootstrap/zig/doc/langref/enum\_export\_error.zig:2:17: error: parameter of type 'enum\_export\_error.Foo' not allowed in function with calling convention 'x86\_64\_sysv'
export fn entry(foo: Foo) void {
                ^~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/enum\_export\_error.zig:2:17: note: enum tag type 'u2' is not extern compatible
/home/ci/zig-bootstrap/zig/doc/langref/enum\_export\_error.zig:2:17: note: only integers with 0, 8, 16, 32, 64 and 128 bits are extern compatible
/home/ci/zig-bootstrap/zig/doc/langref/enum\_export\_error.zig:1:13: note: enum declared here
const Foo = enum { a, b, c };
            ^~~~~~~~~~~~~~~~
referenced by:
...
## [union](https://ziglang.org/documentation/master/#toc-union) [§](https://ziglang.org/documentation/master/#union)

A bare `union` defines a set of possible types that a value can be as a list of fields. Only one field can be active at a time. The in-memory representation of bare unions is not guaranteed. Bare unions cannot be used to reinterpret memory. For that, use [@ptrCast](https://ziglang.org/documentation/master/#ptrCast), or use an [extern union](https://ziglang.org/documentation/master/#extern-union) or a [packed union](https://ziglang.org/documentation/master/#packed-union) which have guaranteed in-memory layout. [Accessing the non-active field](https://ziglang.org/documentation/master/#Wrong-Union-Field-Access) is safety-checked [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior):
...
1/1 test\_wrong\_union\_access.test.simple union...thread 789948 panic: access of union field 'float' while field 'int' is active
/home/ci/zig-bootstrap/zig/doc/langref/test\_wrong\_union\_access.zig:8:12: 0x1036042 in test.simple union (test\_wrong\_union\_access.zig)
    payload.float = 12.34;
           ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c0147 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11b9f52 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b6672 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b60a1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/ef9e311599c3fe9946db59b760edd2bf/test --seed=0x1c0ac5be
...
In order to use [switch](https://ziglang.org/documentation/master/#switch) with a union, it must be a [Tagged union](https://ziglang.org/documentation/master/#Tagged-union).

To initialize a union when the tag is a [comptime](https://ziglang.org/documentation/master/#comptime)\-known name, see [@unionInit](https://ziglang.org/documentation/master/#unionInit).

### [Tagged union](https://ziglang.org/documentation/master/#toc-Tagged-union) [§](https://ziglang.org/documentation/master/#Tagged-union)

Unions can be declared with an enum tag type. This turns the union into a *tagged* union, which makes it eligible to use with [switch](https://ziglang.org/documentation/master/#switch) expressions. When switching on tagged unions, the tag value can be obtained using an additional capture. Tagged unions coerce to their tag type: [Type Coercion: Unions and Enums](https://ziglang.org/documentation/master/#Type-Coercion-Unions-and-Enums).
...
Unions with inferred enum tag types can also assign ordinal values to their inferred tag. This requires the tag to specify an explicit integer type. [@intFromEnum](https://ziglang.org/documentation/master/#intFromEnum) can be used to access the ordinal value corresponding to the active field.
...
All fields in a packed union must have the same [@bitSizeOf](https://ziglang.org/documentation/master/#bitSizeOf).
...
## [opaque](https://ziglang.org/documentation/master/#toc-opaque) [§](https://ziglang.org/documentation/master/#opaque)

`opaque {}` declares a new type with an unknown (but non-zero) size and alignment. It can contain declarations the same as [structs](https://ziglang.org/documentation/master/#struct), [unions](https://ziglang.org/documentation/master/#union), and [enums](https://ziglang.org/documentation/master/#enum).
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:6:9: error: expected type '\*test\_opaque.Derp', found '\*test\_opaque.Wat'
    bar(w);
        ^
/home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:6:9: note: pointer type child 'test\_opaque.Wat' cannot cast into pointer type child 'test\_opaque.Derp'
/home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:2:13: note: opaque declared here
const Wat = opaque {};
            ^~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:1:14: note: opaque declared here
const Derp = opaque {};
             ^~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:4:18: note: parameter type declared here
extern fn bar(d: \*Derp) void;
                 ^~~~~
referenced by:
    test.call foo: /home/ci/zig-bootstrap/zig/doc/langref/test\_opaque.zig:10:8

## [Blocks](https://ziglang.org/documentation/master/#toc-Blocks) [§](https://ziglang.org/documentation/master/#Blocks)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_blocks.zig:6:5: error: use of undeclared identifier 'x'
    x += 1;
    ^
...
-   [Labeled for](https://ziglang.org/documentation/master/#Labeled-for)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_shadowing.zig:6:13: error: local variable shadows declaration of 'pi'
        var pi: i32 = 1234;
            ^~
/home/ci/zig-bootstrap/zig/doc/langref/test\_shadowing.zig:1:1: note: declared here
const pi = 3.14;
^~~~~~~~~~~~~~~
...
## [switch](https://ziglang.org/documentation/master/#toc-switch) [§](https://ziglang.org/documentation/master/#switch)
...
`switch` can be used to capture the field values of a [Tagged union](https://ziglang.org/documentation/master/#Tagged-union). Modifications to the field values can be done by placing a `*` before the capture variable name, turning it into a pointer.
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_unhandled\_enumeration\_value.zig:9:5: error: switch must handle all possibilities
    switch (color) {
    ^~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_unhandled\_enumeration\_value.zig:3:5: note: unhandled enumeration value: 'off'
    off,
    ^~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_unhandled\_enumeration\_value.zig:1:15: note: enum 'test\_unhandled\_enumeration\_value.Color' declared here
const Color = enum {
              ^~~~
...
### [Switching on Errors](https://ziglang.org/documentation/master/#toc-Switching-on-Errors) [§](https://ziglang.org/documentation/master/#Switching-on-Errors)
...
## [while](https://ziglang.org/documentation/master/#toc-while) [§](https://ziglang.org/documentation/master/#while)
...
## [for](https://ziglang.org/documentation/master/#toc-for) [§](https://ziglang.org/documentation/master/#for)
...
## [if](https://ziglang.org/documentation/master/#toc-if) [§](https://ziglang.org/documentation/master/#if)
...
## [defer](https://ziglang.org/documentation/master/#toc-defer) [§](https://ziglang.org/documentation/master/#defer)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_invalid\_defer.zig:3:9: error: cannot return from defer expression
        return error.DeferError;
        ^~~~~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_invalid\_defer.zig:2:5: note: defer expression here
    defer {
    ^~~~~
...
## [unreachable](https://ziglang.org/documentation/master/#toc-unreachable) [§](https://ziglang.org/documentation/master/#unreachable)

In [Debug](https://ziglang.org/documentation/master/#Debug) and [ReleaseSafe](https://ziglang.org/documentation/master/#ReleaseSafe) mode `unreachable` emits a call to `panic` with the message `reached unreachable code`.

In [ReleaseFast](https://ziglang.org/documentation/master/#ReleaseFast) and [ReleaseSmall](https://ziglang.org/documentation/master/#ReleaseSmall) mode, the optimizer uses the assumption that `unreachable` code will never be hit to perform optimizations.
...
1/1 test\_assertion\_failure.test.this will fail...thread 788662 panic: reached unreachable code
/home/ci/zig-bootstrap/zig/doc/langref/test\_assertion\_failure.zig:3:14: 0x1036039 in assert (test\_assertion\_failure.zig)
    if (!ok) unreachable; // assertion failure
             ^
/home/ci/zig-bootstrap/zig/doc/langref/test\_assertion\_failure.zig:8:11: 0x103600e in test.this will fail (test\_assertion\_failure.zig)
    assert(false);
          ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c00a7 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11b9eb2 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b65d2 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b6001 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/54e8acba9de10600bdef913fb363013c/test --seed=0x48015435
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_unreachable.zig:10:16: error: unreachable code
        assert(@TypeOf(unreachable) == noreturn);
               ^~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_unreachable.zig:10:24: note: control flow is diverted here
        assert(@TypeOf(unreachable) == noreturn);
                       ^~~~~~~~~~~
...
## [noreturn](https://ziglang.org/documentation/master/#toc-noreturn) [§](https://ziglang.org/documentation/master/#noreturn)
...
## [Functions](https://ziglang.org/documentation/master/#toc-Functions) [§](https://ziglang.org/documentation/master/#Functions)
...
There is a difference between a function *body* and a function *pointer*. Function bodies are [comptime](https://ziglang.org/documentation/master/#comptime)\-only types while function [Pointers](https://ziglang.org/documentation/master/#Pointers) may be runtime-known.
...
## [Errors](https://ziglang.org/documentation/master/#toc-Errors) [§](https://ziglang.org/documentation/master/#Errors)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_coerce\_error\_superset\_to\_subset.zig:16:12: error: expected type 'error{OutOfMemory}', found 'error{AccessDenied,FileNotFound,OutOfMemory}'
    return err;
           ^~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_coerce\_error\_superset\_to\_subset.zig:16:12: note: 'error.AccessDenied' not a member of destination error set
/home/ci/zig-bootstrap/zig/doc/langref/test\_coerce\_error\_superset\_to\_subset.zig:16:12: note: 'error.FileNotFound' not a member of destination error set
/home/ci/zig-bootstrap/zig/doc/langref/test\_coerce\_error\_superset\_to\_subset.zig:15:28: note: function return type declared here
fn foo(err: FileOpenError) AllocationError {
                           ^~~~~~~~~~~~~~~
referenced by:
    test.coerce superset to subset: /home/ci/zig-bootstrap/zig/doc/langref/test\_coerce\_error\_superset\_to\_subset.zig:12:8
...
The global error set should generally be avoided because it prevents the compiler from knowing what errors are possible at compile-time. Knowing the error set at compile-time is better for generated documentation and helpful error messages, such as forgetting a possible error value in a [switch](https://ziglang.org/documentation/master/#switch).
...
#### [Inferred Error Sets](https://ziglang.org/documentation/master/#toc-Inferred-Error-Sets) [§](https://ziglang.org/documentation/master/#Inferred-Error-Sets)
...
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:34:5: 0x11a1ecc in bang1 (error\_return\_trace.zig)
    return error.FileNotFound;
    ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:22:5: 0x11a1f2c in baz (error\_return\_trace.zig)
    try bang1();
    ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:38:5: 0x11a1f6c in bang2 (error\_return\_trace.zig)
    return error.PermissionDenied;
    ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:30:5: 0x11a204c in hello (error\_return\_trace.zig)
    try bang2();
    ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:17:31: 0x11a215a in bar (error\_return\_trace.zig)
        error.FileNotFound => try hello(),
                              ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:7:9: 0x11a223a in foo (error\_return\_trace.zig)
        try bar();
        ^
/home/ci/zig-bootstrap/zig/doc/langref/error\_return\_trace.zig:2:5: 0x11a2341 in main (error\_return\_trace.zig)
    try foo(12);
    ^
...
$ ./stack\_trace
thread 791613 panic: PermissionDenied
/home/ci/zig-bootstrap/zig/doc/langref/stack\_trace.zig:38:5: 0x11a3cfa in bang2 (stack\_trace.zig)
    @panic("PermissionDenied");
    ^
/home/ci/zig-bootstrap/zig/doc/langref/stack\_trace.zig:30:10: 0x11a428c in hello (stack\_trace.zig)
    bang2();
         ^
/home/ci/zig-bootstrap/zig/doc/langref/stack\_trace.zig:17:14: 0x11a3cb3 in bar (stack\_trace.zig)
        hello();
             ^
/home/ci/zig-bootstrap/zig/doc/langref/stack\_trace.zig:7:12: 0x11a37a8 in foo (stack\_trace.zig)
        bar();
           ^
/home/ci/zig-bootstrap/zig/doc/langref/stack\_trace.zig:2:8: 0x11a2da1 in main (stack\_trace.zig)
    foo(12);
       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
                                                          ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11a1eb1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
...
Error Return Traces are enabled by default in [Debug](https://ziglang.org/documentation/master/#Debug) builds and disabled by default in [ReleaseFast](https://ziglang.org/documentation/master/#ReleaseFast), [ReleaseSafe](https://ziglang.org/documentation/master/#ReleaseSafe) and [ReleaseSmall](https://ziglang.org/documentation/master/#ReleaseSmall) builds.
...
## [Optionals](https://ziglang.org/documentation/master/#toc-Optionals) [§](https://ziglang.org/documentation/master/#Optionals)
...
-   [if with Optionals](https://ziglang.org/documentation/master/#if-with-Optionals)

## [Casting](https://ziglang.org/documentation/master/#toc-Casting) [§](https://ziglang.org/documentation/master/#Casting)

A **type cast** converts a value of one type to another. Zig has [Type Coercion](https://ziglang.org/documentation/master/#Type-Coercion) for conversions that are known to be completely safe and unambiguous, and [Explicit Casts](https://ziglang.org/documentation/master/#Explicit-Casts) for conversions that one would not want to happen on accident. There is also a third kind of type conversion called [Peer Type Resolution](https://ziglang.org/documentation/master/#Peer-Type-Resolution) for the case when a result type must be decided given multiple operand types.
...
Type coercions are only allowed when it is completely unambiguous how to get from one type to another, and the transformation is guaranteed to be safe. There is one exception, which is [C Pointers](https://ziglang.org/documentation/master/#C-Pointers).
...
[Integers](https://ziglang.org/documentation/master/#Integers) coerce to integer types which can represent every value of the old type, and likewise [Floats](https://ziglang.org/documentation/master/#Floats) coerce to float types which can represent every value of the old type.
...
#### [Type Coercion: Int to Float](https://ziglang.org/documentation/master/#toc-Type-Coercion-Int-to-Float) [§](https://ziglang.org/documentation/master/#Type-Coercion-Int-to-Float)

[Integers](https://ziglang.org/documentation/master/#Integers) coerce to [Floats](https://ziglang.org/documentation/master/#Floats) if every possible integer value can be stored in the float without rounding (i.e. the integer's precision does not exceed the float's significand precision). Larger integer types that cannot be safely coerced must be explicitly casted with [@floatFromInt](https://ziglang.org/documentation/master/#floatFromInt).
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_failed\_int\_to\_float\_coercion.zig:4:24: error: expected type 'f32', found 'u25'
    const float: f32 = int;
                       ^~~
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_ambiguous\_coercion.zig:3:25: error: ambiguous coercion of division operands 'comptime\_float' and 'comptime\_int'; non-zero remainder '4'
    const f: f32 = 54.0 / 5;
                   \~~~~~^~~

#### [Type Coercion: Slices, Arrays and Pointers](https://ziglang.org/documentation/master/#toc-Type-Coercion-Slices-Arrays-and-Pointers) [§](https://ziglang.org/documentation/master/#Type-Coercion-Slices-Arrays-and-Pointers)
...
#### [Type Coercion: Optionals](https://ziglang.org/documentation/master/#toc-Type-Coercion-Optionals) [§](https://ziglang.org/documentation/master/#Type-Coercion-Optionals)
...
#### [Type Coercion: Unions and Enums](https://ziglang.org/documentation/master/#toc-Type-Coercion-Unions-and-Enums) [§](https://ziglang.org/documentation/master/#Type-Coercion-Unions-and-Enums)
...
-   [@errorCast](https://ziglang.org/documentation/master/#errorCast) - convert to a smaller error set
...
-   [@ptrFromInt](https://ziglang.org/documentation/master/#ptrFromInt) - convert an address to a pointer
...
## [Zero Bit Types](https://ziglang.org/documentation/master/#toc-Zero-Bit-Types) [§](https://ziglang.org/documentation/master/#Zero-Bit-Types)

For some types, [@sizeOf](https://ziglang.org/documentation/master/#sizeOf) is 0:

-   [void](https://ziglang.org/documentation/master/#void)

-   The [Integers](https://ziglang.org/documentation/master/#Integers) `u0` and `i0`.
-   [Arrays](https://ziglang.org/documentation/master/#Arrays) and [Vectors](https://ziglang.org/documentation/master/#Vectors) with len 0, or with an element type that is a zero bit type.

-   An [enum](https://ziglang.org/documentation/master/#enum) with only 1 tag.
-   A [struct](https://ziglang.org/documentation/master/#struct) with all fields being zero bit types.

-   A [union](https://ziglang.org/documentation/master/#union) with only 1 field which is a zero bit type.
...
When this turns into machine code, there is no code generated in the body of `entry`, even in [Debug](https://ziglang.org/documentation/master/#Debug) mode. For example, on x86\_64:
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_expression\_ignored.zig:2:8: error: value of type 'i32' ignored
    foo();
    \~~~^~
/home/ci/zig-bootstrap/zig/doc/langref/test\_expression\_ignored.zig:2:8: note: all non-void values must be used
/home/ci/zig-bootstrap/zig/doc/langref/test\_expression\_ignored.zig:2:8: note: to discard the value, assign it to '\_'
...
## [Result Location Semantics](https://ziglang.org/documentation/master/#toc-Result-Location-Semantics) [§](https://ziglang.org/documentation/master/#Result-Location-Semantics)
...
/home/ci/zig-bootstrap/out/host/lib/zig/std/testing.zig:612:14: 0x1022019 in expect (std.zig)
    if (!ok) return error.TestUnexpectedResult;
             ^
/home/ci/zig-bootstrap/zig/doc/langref/result\_location\_interfering\_with\_swap.zig:10:5: 0x102216b in test.attempt to swap array elements with array initializer (result\_location\_interfering\_with\_swap.zig)
    try expect(arr\[1\] == 1); // fails
    ^
0 passed; 0 skipped; 1 failed.
error: the following test command failed with exit code 1:
/home/ci/zig-bootstrap/out/zig-local-cache/o/dd7f5bc7e025b912cda52838e076cede/test --seed=0x290a45f2
...
## [comptime](https://ziglang.org/documentation/master/#toc-comptime) [§](https://ziglang.org/documentation/master/#comptime)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_unresolved\_comptime\_value.zig:8:28: error: unable to resolve comptime value
    const result = max(if (condition) f32 else u64, 1234, 5678);
                           ^~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_unresolved\_comptime\_value.zig:8:24: note: argument to comptime parameter must be comptime-known
    const result = max(if (condition) f32 else u64, 1234, 5678);
                       ^~~~~~~~~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_unresolved\_comptime\_value.zig:1:8: note: parameter declared comptime here
fn max(comptime T: type, a: T, b: T) T {
       ^~~~~~~~
referenced by:
    test.try to pass a runtime type: /home/ci/zig-bootstrap/zig/doc/langref/test\_unresolved\_comptime\_value.zig:5:8
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_mismatched\_type.zig:2:18: error: operator > not allowed for type 'bool'
    return if (a > b) a else b;
               ~~^~~
referenced by:
    test.try to compare bools: /home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_mismatched\_type.zig:5:12
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_call\_extern\_function.zig:5:13: error: comptime call of extern function
        exit();
        \~~~~^~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_call\_extern\_function.zig:4:5: note: 'comptime' keyword forces comptime evaluation
    comptime {
    ^~~~~~~~
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_fibonacci\_comptime\_overflow.zig:5:28: error: overflow of integer type 'u32' with value '-1'
    return fibonacci(index - 1) + fibonacci(index - 2);
                     \~~~~~~^~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_fibonacci\_comptime\_overflow.zig:5:21: note: called at comptime here (7 times)    return fibonacci(index - 1) + fibonacci(index - 2);
           \~~~~~~~~~^~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_fibonacci\_comptime\_overflow.zig:9:34: note: called at comptime here
    try comptime expect(fibonacci(7) == 13);
                        \~~~~~~~~~^~~
...
/home/ci/zig-bootstrap/out/host/lib/zig/std/debug.zig:419:14: error: reached unreachable code
    if (!ok) unreachable; // assertion failure
             ^~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_fibonacci\_comptime\_unreachable.zig:9:24: note: called at comptime here
    try comptime assert(fibonacci(7) == 99999);
                 \~~~~~~^~~~~~~~~~~~~~~~~~~~~~~
...
/home/ci/zig-bootstrap/out/host/lib/zig/std/Io/Writer.zig:720:18: error: unused argument in 'here is a string: '{s}' here is a number: {}
            ...
            1 => @compileError("unused argument in '" ++ fmt ++ "'"),
                 ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
referenced by:
    print\_\_anon\_518: /home/ci/zig-bootstrap/out/host/lib/zig/std/debug.zig:311:39
    test.print too many arguments: /home/ci/zig-bootstrap/zig/doc/langref/test\_print\_too\_many\_args.zig:7:10
...
## [Assembly](https://ziglang.org/documentation/master/#toc-Assembly) [§](https://ziglang.org/documentation/master/#Assembly)
...
## [Builtin Functions](https://ziglang.org/documentation/master/#toc-Builtin-Functions) [§](https://ziglang.org/documentation/master/#Builtin-Functions)
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_compileLog\_builtin.zig:5:5: error: found compile log statement
    @compileLog("comptime val1 = ", val1);
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_compileLog\_builtin.zig:11:5: note: also here
    @compileLog("comptime in main");
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
referenced by:
    test.main: /home/ci/zig-bootstrap/zig/doc/langref/test\_compileLog\_builtin.zig:13:46
Compile Log Output:
...
1/1 test\_intCast\_builtin.test.integer cast panic...thread 791253 panic: integer does not fit in destination type
/home/ci/zig-bootstrap/zig/doc/langref/test\_intCast\_builtin.zig:4:19: 0x1036020 in test.integer cast panic (test\_intCast\_builtin.zig)
    const b: u8 = @intCast(a);
                  ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c00a7 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
...
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b6001 in \_start (std.zig)
    ...
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/425ce570afbbf36fc257f8bffac336fb/test --seed=0x5ef6f623
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_without\_setEvalBranchQuota\_builtin.zig:4:9: error: evaluation exceeded 1000 backwards branches
        while (i < 1001) : (i += 1) {}
        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_without\_setEvalBranchQuota\_builtin.zig:4:9: note: use @setEvalBranchQuota() to raise the branch limit from 1000
...
1/1 test\_setRuntimeSafety\_builtin.test.@setRuntimeSafety...thread 790815 panic: integer overflow
/home/ci/zig-bootstrap/zig/doc/langref/test\_setRuntimeSafety\_builtin.zig:11:11: 0x1062338 in test.@setRuntimeSafety (test)
        x += 1;
          ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x1058eb8 in mainTerminal (test)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x105846f in callMain (test)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x105810d in \_start (test)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/8ad0073e7f0e93ff61cb93294f02b15c/test --seed=0xd7311026
...
### [@EnumLiteral](https://ziglang.org/documentation/master/#toc-EnumLiteral) [§](https://ziglang.org/documentation/master/#EnumLiteral)
...
### [@Int](https://ziglang.org/documentation/master/#toc-Int) [§](https://ziglang.org/documentation/master/#Int)
...
### [@Tuple](https://ziglang.org/documentation/master/#toc-Tuple) [§](https://ziglang.org/documentation/master/#Tuple)
...
### [@Pointer](https://ziglang.org/documentation/master/#toc-Pointer) [§](https://ziglang.org/documentation/master/#Pointer)
...
### [@Fn](https://ziglang.org/documentation/master/#toc-Fn) [§](https://ziglang.org/documentation/master/#Fn)
...
## [Build Mode](https://ziglang.org/documentation/master/#toc-Build-Mode) [§](https://ziglang.org/documentation/master/#Build-Mode)

Zig has four build modes:

-   [Debug](https://ziglang.org/documentation/master/#Debug) (default)
...
## [Illegal Behavior](https://ziglang.org/documentation/master/#toc-Illegal-Behavior) [§](https://ziglang.org/documentation/master/#Illegal-Behavior)
...
All other Illegal Behavior is *unchecked*, meaning the compiler is unable to insert safety checks for it. If Unchecked Illegal Behavior is invoked at runtime, anything can happen: usually that will be some kind of crash, but the optimizer is free to make Unchecked Illegal Behavior do anything, such as calling arbitrary functions or clobbering arbitrary data. This is similar to the concept of "undefined behavior" in some other languages. Note that Unchecked Illegal Behavior still always results in a compile error if evaluated at [comptime](https://ziglang.org/documentation/master/#comptime), because the Zig compiler is able to perform more sophisticated checks at compile-time than at runtime.

Most Illegal Behavior is safety-checked. However, to facilitate optimizations, safety checks are disabled by default in the [ReleaseFast](https://ziglang.org/documentation/master/#ReleaseFast) and [ReleaseSmall](https://ziglang.org/documentation/master/#ReleaseSmall) optimization modes. Safety checks can also be enabled or disabled on a per-block basis, overriding the default for the current optimization mode, using [@setRuntimeSafety](https://ziglang.org/documentation/master/#setRuntimeSafety). When safety checks are disabled, Safety-Checked Illegal Behavior behaves like Unchecked Illegal Behavior; that is, any behavior may result from invoking it.
...
1/1 test\_illegal\_behavior.test.safety check...thread 791473 panic: reached unreachable code
/home/ci/zig-bootstrap/zig/doc/langref/test\_illegal\_behavior.zig:2:5: 0x103600c in test.safety check (test\_illegal\_behavior.zig)
    unreachable;
    ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:253:25: 0x11c0077 in mainTerminal (test\_runner.zig)
        if (test\_fn.func()) |\_| {
                        ^
/home/ci/zig-bootstrap/out/host/lib/zig/compiler/test\_runner.zig:70:28: 0x11b9e82 in main (test\_runner.zig)
        return mainTerminal(init);
                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:676:88: 0x11b65a2 in callMain (std.zig)
    if (fn\_info.params\[0\].type.? == std.process.Init.Minimal) return wrapMain(root.main(.{
                                                                                       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11b5fd1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
    ^
error: the following test command terminated with signal ABRT:
/home/ci/zig-bootstrap/out/zig-local-cache/o/a580d2688023f6e182e130d0c9eae76e/test --seed=0xd458ff22
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_reaching\_unreachable.zig:5:14: error: reached unreachable code
    if (!ok) unreachable; // assertion failure
             ^~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_reaching\_unreachable.zig:2:11: note: called at comptime here
    assert(false);
    \~~~~~~^~~~~~~
...
thread 790816 panic: reached unreachable code
/home/ci/zig-bootstrap/out/host/lib/zig/std/debug.zig:419:14: 0x1031679 in assert (std.zig)
    if (!ok) unreachable; // assertion failure
             ^
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_reaching\_unreachable.zig:4:21: 0x11a2d9e in main (runtime\_reaching\_unreachable.zig)
    std.debug.assert(false);
                    ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_index\_out\_of\_bounds.zig:3:27: error: index 5 outside array of length 5
    const garbage = array\[5\];
                          ^
...
thread 788881 panic: index out of bounds: index 5, len 5
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_index\_out\_of\_bounds.zig:7:13: 0x11a37ee in foo (runtime\_index\_out\_of\_bounds.zig)
    return x\[5\];
            ^
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_index\_out\_of\_bounds.zig:2:18: 0x11a2daa in main (runtime\_index\_out\_of\_bounds.zig)
    const x = foo("hello");
                 ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_cast.zig:3:36: error: type 'u32' cannot represent integer value '-1'
    const unsigned: u32 = @intCast(value);
                                   ^~~~~
...
thread 787852 panic: integer does not fit in destination type
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_cast.zig:6:27: 0x11a2daf in main (runtime\_invalid\_cast.zig)
    const unsigned: u32 = @intCast(value);
                          ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_cast\_truncate.zig:3:31: error: type 'u8' cannot represent integer value '300'
...
thread 789950 panic: integer does not fit in destination type
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_cast\_truncate.zig:6:22: 0x11a2db0 in main (runtime\_invalid\_cast\_truncate.zig)
    const byte: u8 = @intCast(spartan\_count);
                     ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_overflow.zig:3:10: error: overflow of integer type 'u8' with value '256'
    byte += 1;
    \~~~~~^~~~
...
$ ./runtime\_overflow
thread 788122 panic: integer overflow
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_overflow.zig:5:10: 0x11a2dc5 in main (runtime\_overflow.zig)
    byte += 1;
         ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
#### [Standard Library Math Functions](https://ziglang.org/documentation/master/#toc-Standard-Library-Math-Functions) [§](https://ziglang.org/documentation/master/#Standard-Library-Math-Functions)
...
error: Overflow
/home/ci/zig-bootstrap/out/host/lib/zig/std/math.zig:565:21: 0x11a3004 in add\_\_anon\_29550 (std.zig)
    if (ov\[1\] != 0) return error.Overflow;
                    ^
/home/ci/zig-bootstrap/zig/doc/langref/math\_add.zig:8:9: 0x11a1f74 in main (math\_add.zig)
        return err;
        ^
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_shlExact\_overflow.zig:2:15: error: overflow of integer type 'u8' with value '340'
    const x = @shlExact(@as(u8, 0b01010101), 2);
              ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
thread 790020 panic: left shift overflowed bits
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_shlExact\_overflow.zig:6:5: 0x11a2dd1 in main (runtime\_shlExact\_overflow.zig)
    const y = @shlExact(x, 2);
    ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_shrExact\_overflow.zig:2:15: error: exact shift shifted out 1 bits
    const x = @shrExact(@as(u8, 0b10101010), 2);
              ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
thread 789636 panic: right shift overflowed bits
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_shrExact\_overflow.zig:7:5: 0x11a2dba in main (runtime\_shrExact\_overflow.zig)
    const y = @shrExact(x, 2);
    ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_division\_by\_zero.zig:4:19: error: division by zero here causes illegal behavior
    const c = a / b;
                  ^
...
thread 791790 panic: division by zero
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_division\_by\_zero.zig:7:17: 0x11a2dc0 in main (runtime\_division\_by\_zero.zig)
    const c = a / b;
                ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_remainder\_division\_by\_zero.zig:4:19: error: division by zero here causes illegal behavior
    const c = a % b;
                  ^
...
thread 789074 panic: division by zero
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_remainder\_division\_by\_zero.zig:7:17: 0x11a2dc0 in main (runtime\_remainder\_division\_by\_zero.zig)
    const c = a % b;
                ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_divExact\_remainder.zig:4:15: error: exact division produced remainder
    const c = @divExact(a, b);
              ^~~~~~~~~~~~~~~
...
thread 789153 panic: exact division produced remainder
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_divExact\_remainder.zig:7:15: 0x11a2df5 in main (runtime\_divExact\_remainder.zig)
    const c = @divExact(a, b);
              ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_unwrap\_null.zig:3:35: error: unable to unwrap null
...
thread 789071 panic: attempt to use null value
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_unwrap\_null.zig:6:35: 0x11a2dc4 in main (runtime\_unwrap\_null.zig)
    const number = optional\_number.?;
                                  ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_unwrap\_error.zig:2:44: error: caught unexpected error 'UnableToReturnNumber'
    const number = getNumberOrFail() catch unreachable;
                                           ^~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_unwrap\_error.zig:7:18: note: error returned here
    return error.UnableToReturnNumber;
                 ^~~~~~~~~~~~~~~~~~~~
...
thread 789837 panic: attempt to unwrap error: UnableToReturnNumber
error return context:
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_unwrap\_error.zig:9:5: 0x11a2d9c in getNumberOrFail (runtime\_unwrap\_error.zig)
    return error.UnableToReturnNumber;
    ^

stack trace:
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_unwrap\_error.zig:4:44: 0x11a2e03 in main (runtime\_unwrap\_error.zig)
    const number = getNumberOrFail() catch unreachable;
                                           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_error\_code.zig:4:39: error: integer value '11' represents no error
...
thread 790189 panic: invalid error code
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_error\_code.zig:7:5: 0x11a2dd7 in main (runtime\_invalid\_error\_code.zig)
    const invalid\_err = @errorFromInt(number);
    ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_enum\_cast.zig:8:20: error: enum 'test\_comptime\_invalid\_enum\_cast.Foo' has no tag with value '3'
    const b: Foo = @enumFromInt(a);
                   ^~~~~~~~~~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_enum\_cast.zig:1:13: note: enum declared here
const Foo = enum {
            ^~~~
...
thread 789072 panic: invalid enum value
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_enum\_cast.zig:12:20: 0x11a2e20 in main (runtime\_invalid\_enum\_cast.zig)
    const b: Foo = @enumFromInt(a);
                   ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_error\_set\_cast.zig:10:19: error: 'error.B' not a member of error set 'error{A,C}'
    \_ = @as(Set2, @errorCast(Set1.B));
                  ^~~~~~~~~~~~~~~~~~
...
thread 787976 panic: invalid error code
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_error\_set\_cast.zig:15:21: 0x11a380c in foo (runtime\_invalid\_error\_set\_cast.zig)
    const x: Set2 = @errorCast(set1);
                    ^
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_error\_set\_cast.zig:12:8: 0x11a2da7 in main (runtime\_invalid\_error\_set\_cast.zig)
    foo(Set1.B);
       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_incorrect\_pointer\_alignment.zig:3:47: error: pointer address 0x1 is not aligned to 4 bytes
    const aligned: \*align(4) i32 = @alignCast(ptr);
                                              ^~~
...
thread 789070 panic: incorrect alignment
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_incorrect\_pointer\_alignment.zig:9:64: 0x11a2ff6 in foo (runtime\_incorrect\_pointer\_alignment.zig)
    const int\_slice = mem.bytesAsSlice(u32, @as(\[\]align(4) u8, @alignCast(slice4)));
                                                               ^
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_incorrect\_pointer\_alignment.zig:5:12: 0x11a1f0e in main (runtime\_incorrect\_pointer\_alignment.zig)
    if (foo(bytes) != 0x11111111) return error.Wrong;
           ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a24d8 in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
                                                          ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:190:5: 0x11a1eb1 in \_start (std.zig)
    asm volatile (switch (native\_arch) {
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_wrong\_union\_field\_access.zig:3:6: error: access of union field 'float' while field 'int' is active
    f.float = 12.34;
    ~^~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_wrong\_union\_field\_access.zig:6:13: note: union declared here
const Foo = union {
            ^~~~~
...
thread 787958 panic: access of union field 'float' while field 'int' is active
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_wrong\_union\_field\_access.zig:14:6: 0x11a37de in bar (runtime\_wrong\_union\_field\_access.zig)
    f.float = 12.34;
     ^
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_wrong\_union\_field\_access.zig:10:8: 0x11a2dae in main (runtime\_wrong\_union\_field\_access.zig)
    bar(&f);
       ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_out\_of\_bounds\_float\_to\_integer\_cast.zig:3:36: error: float value '4294967296' cannot be stored in integer type 'i32'
    const int: i32 = @intFromFloat(float);
                                   ^~~~~
...
thread 790121 panic: integer part of floating point value out of bounds
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_out\_of\_bounds\_float\_to\_integer\_cast.zig:4:22: 0x11a2ddf in main (runtime\_out\_of\_bounds\_float\_to\_integer\_cast.zig)
    const int: i32 = @intFromFloat(float);
                     ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_comptime\_invalid\_null\_pointer\_cast.zig:3:32: error: null pointer casted to type '\*i32'
...
thread 788884 panic: cast causes pointer to be null
/home/ci/zig-bootstrap/zig/doc/langref/runtime\_invalid\_null\_pointer\_cast.zig:4:23: 0x11a2dba in main (runtime\_invalid\_null\_pointer\_cast.zig)
    const ptr: \*i32 = @ptrCast(opt\_ptr);
                      ^
/home/ci/zig-bootstrap/out/host/lib/zig/std/start.zig:675:59: 0x11a242d in callMain (std.zig)
    if (fn\_info.params.len == 0) return wrapMain(root.main());
...
## [Memory](https://ziglang.org/documentation/master/#toc-Memory) [§](https://ziglang.org/documentation/master/#Memory)
...
[Where are the bytes?](https://ziglang.org/documentation/master/#Where-are-the-bytes)
...
Zig has a general purpose allocator available to be imported with `std.heap.GeneralPurposeAllocator`. However, it is still recommended to follow the [Choosing an Allocator](https://ziglang.org/documentation/master/#Choosing-an-Allocator) guide.
...
3.  Is the maximum number of bytes that you will need bounded by a number known at [comptime](https://ziglang.org/documentation/master/#comptime)? In this case, use `std.heap.FixedBufferAllocator`.
...
/home/ci/zig-bootstrap/zig/doc/langref/test\_string\_literal\_to\_slice.zig:6:9: error: expected type '\[\]u8', found '\*const \[5:0\]u8'
    foo("hello");
        ^~~~~~~
/home/ci/zig-bootstrap/zig/doc/langref/test\_string\_literal\_to\_slice.zig:6:9: note: cast discards const qualifier
/home/ci/zig-bootstrap/zig/doc/langref/test\_string\_literal\_to\_slice.zig:1:11: note: parameter type declared here
fn foo(s: \[\]u8) void {
          ^~~~
...
## [Compile Variables](https://ziglang.org/documentation/master/#toc-Compile-Variables) [§](https://ziglang.org/documentation/master/#Compile-Variables)
...
pub const zig_version_string = "0.16.0-dev.2193+fc517bd01";
...
## [Compilation Model](https://ziglang.org/documentation/master/#toc-Compilation-Model) [§](https://ziglang.org/documentation/master/#Compilation-Model)
...
Such files can be instantiated just like any other `struct` type. A file's "root struct type" can be referred to within that file using [@This](https://ziglang.org/documentation/master/#This).
...
## [Zig Build System](https://ziglang.org/documentation/master/#toc-Zig-Build-System) [§](https://ziglang.org/documentation/master/#Zig-Build-System)
...
-   Surfacing build configuration as [comptime](https://ziglang.org/documentation/master/#comptime) values by providing a file that can be [imported](https://ziglang.org/documentation/master/#import) by Zig code.
...
## [C](https://ziglang.org/documentation/master/#toc-C) [§](https://ziglang.org/documentation/master/#C)
...
info(compilation): writing C import source to /home/ci/zig-bootstrap/out/zig-local-cache/tmp/192ecfce88b86cb6/cimport.h
--zig-integration -x c -isystem /home/ci/zig-bootstrap/out/host/lib/zig/compiler/aro/include -fno-PIE -fPIC -gdwarf-4 -gdwarf32 -fno-lto -MD -MV -MF /home/ci/zig-bootstrap/out/zig-local-cache/tmp/192ecfce88b86cb6/cimport.h.d -fhosted -nostdinc -D\_\_GLIBC\_MINOR\_\_=31 -isystem /home/ci/zig-bootstrap/out/host/lib/zig/include -isystem /usr/include -isystem /usr/include/x86\_64-linux-gnu -O0 -target x86\_64-linux.5.10...5.10-gnu.2.31 -mcpu=znver2-16bit\_mode-32bit\_mode-3dnow-3dnowa+64bit+adx+aes+allow\_light\_256\_bit-amx\_avx512-amx\_bf16-amx\_complex-amx\_fp16-amx\_fp8-amx\_int8-amx\_movrs-amx\_tf32-amx\_tile-amx\_transpose+avx-avx10\_1-avx10\_2+avx2-avx512bf16-avx512bitalg-avx512bw-avx512cd-avx512dq-avx512er-avx512f-avx512fp16-avx512ifma-avx512pf-avx512vbmi-avx512vbmi2-avx512vl-avx512vnni-avx512vp2intersect-avx512vpopcntdq-avxifma-avxneconvert-avxvnni-avxvnniint16-avxvnniint8+bmi+bmi2-branch\_hint+branchfusion-bsf\_bsr\_0\_clobbers\_result-ccmp-cf-cldemote+clflushopt+clwb+clzero+cmov-cmpccxadd+crc32+cx16+cx8-egpr-enqcmd-ermsb-evex512+f16c-false\_deps\_getmant-false\_deps\_lzcnt\_tzcnt-false\_deps\_mulc-false\_deps\_mullq-false\_deps\_perm-false\_deps\_popcnt-false\_deps\_range-fast\_11bytenop+fast\_15bytenop-fast\_7bytenop+fast\_bextr-fast\_dpwssd-fast\_gather-fast\_hops+fast\_imm16+fast\_lzcnt+fast\_movbe+fast\_scalar\_fsqrt+fast\_scalar\_shift\_masks-fast\_shld\_rotate-fast\_variable\_crosslane\_shuffle+fast\_variable\_perlane\_shuffle+fast\_vector\_fsqrt-fast\_vector\_shift\_masks-faster\_shift\_than\_shuffle+fma-fma4+fsgsbase-fsrm+fxsr-gfni-harden\_sls\_ijmp-harden\_sls\_ret-hreset-idivl\_to\_divb+idivq\_to\_divl-inline\_asm\_use\_gpr32-invpcid-kl-lea\_sp-lea\_uses\_ag-lvi\_cfi-lvi\_load\_hardening-lwp+lzcnt-macrofusion+mmx+movbe-movdir64b-movdiri-movrs+mwaitx-ndd-nf-no\_bypass\_delay-no\_bypass\_delay\_blend-no\_bypass\_delay\_mov-no\_bypass\_delay\_shuffle+nopl-pad\_short\_functions+pclmul-pconfig-pku+popcnt-ppx-prefer\_128\_bit-prefer\_256\_bit-prefer\_mask\_registers-prefer\_movmsk\_over\_vtest-prefer\_no\_gather-prefer\_no\_scatter-prefetchi-prefetchwt1+prfchw-ptwrite-push2pop2-raoint+rdpid+rdpru+rdrnd+rdseed-retpoline-retpoline\_external\_thunk-retpoline\_indirect\_branches-retpoline\_indirect\_calls-rtm+sahf+sbb\_dep\_breaking-serialize-seses-sgx+sha-sha512-shstk-slow\_3ops\_lea-slow\_incdec-slow\_lea-slow\_pmaddwd-slow\_pmulld+slow\_shld-slow\_two\_mem\_ops-slow\_unaligned\_mem\_16-slow\_unaligned\_mem\_32-sm3-sm4+smap+smep-soft\_float+sse+sse2+sse3+sse4\_1+sse4\_2+sse4a-sse\_unaligned\_mem+ssse3-tagged\_globals-tbm-tsxldtrk-tuning\_fast\_imm\_vector\_shift-uintr-use\_glm\_div\_sqrt\_costs-use\_slm\_arith\_costs-usermsr-vaes-vpclmulqdq+vzeroupper-waitpkg+wbnoinvd-widekl+x87-xop+xsave+xsavec+xsaveopt+xsaves-zu /home/ci/zig-bootstrap/out/zig-local-cache/tmp/192ecfce88b86cb6/cimport.h -o /home/ci/zig-bootstrap/out/zig-local-cache/tmp/192ecfce88b86cb6/cimport.zig
info(compilation): processing dep file at /home/ci/zig-bootstrap/out/zig-local-cache/tmp/192ecfce88b86cb6/cimport.h.d
info(compilation): renaming tmp/192ecfce88b86cb6 to o/2c3db258393a2c1533b9fc17ab765e85
...
Demotion comes in three varieties - [opaque](https://ziglang.org/documentation/master/#opaque), *extern*, and `@compileError`. C structs and unions that cannot be translated correctly will be translated as `opaque{}`. Functions that contain opaque types or code constructs that cannot be translated will be demoted to `extern` declarations. Thus, non-translatable types can still be used as pointers, and non-translatable functions can be called so long as the linker is aware of the compiled function.
...
-   Allows address 0. On non-freestanding targets, dereferencing address 0 is safety-checked [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior). Optional C pointers introduce another bit to keep track of null, just like `?usize`. Note that creating an optional C pointer is unnecessary as one can use normal [Optional Pointers](https://ziglang.org/documentation/master/#Optional-Pointers).
...
## [WebAssembly](https://ziglang.org/documentation/master/#toc-WebAssembly) [§](https://ziglang.org/documentation/master/#WebAssembly)
...
## [Targets](https://ziglang.org/documentation/master/#toc-Targets) [§](https://ziglang.org/documentation/master/#Targets)
...
## [Style Guide](https://ziglang.org/documentation/master/#toc-Style-Guide) [§](https://ziglang.org/documentation/master/#Style-Guide)
...
-   Use the word **assume** to indicate invariants that cause *unchecked* [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior) when violated.

-   Use the word **assert** to indicate invariants that cause *safety-checked* [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior) when violated.

## [Source Encoding](https://ziglang.org/documentation/master/#toc-Source-Encoding) [§](https://ziglang.org/documentation/master/#Source-Encoding)
...
HT hard tabs (byte value 0x09, code point U+0009, `'\t'`) are interchangeable with SP spaces (byte value 0x20, code point U+0020, `' '`) as a token separator, but use of hard tabs is discouraged. See [Grammar](https://ziglang.org/documentation/master/#Grammar).
...
## [Keyword Reference](https://ziglang.org/documentation/master/#toc-Keyword-Reference) [§](https://ziglang.org/documentation/master/#Keyword-Reference)
...
-   See also [Alignment](https://ziglang.org/documentation/master/#Alignment)
...
-   See also [allowzero](https://ziglang.org/documentation/master/#allowzero)
...
-   See also [Operators](https://ziglang.org/documentation/master/#Operators)
...
-   See also [Async Functions](https://ziglang.org/documentation/master/#Async-Functions)
...
-   See also [Function Parameter Type Inference](https://ziglang.org/documentation/master/#Function-Parameter-Type-Inference)
...
-   See also [Assembly](https://ziglang.org/documentation/master/#Assembly)
...
-   See also [Blocks](https://ziglang.org/documentation/master/#Blocks), [while](https://ziglang.org/documentation/master/#while), [for](https://ziglang.org/documentation/master/#for)
...
-   See also [Functions](https://ziglang.org/documentation/master/#Functions)
...
-   See also [catch](https://ziglang.org/documentation/master/#catch), [Operators](https://ziglang.org/documentation/master/#Operators)
...
-   See also [comptime](https://ziglang.org/documentation/master/#comptime)
...
-   See also [Variables](https://ziglang.org/documentation/master/#Variables)
...
-   See also [while](https://ziglang.org/documentation/master/#while), [for](https://ziglang.org/documentation/master/#for)
...
-   See also [defer](https://ziglang.org/documentation/master/#defer)
...
-   See also [if](https://ziglang.org/documentation/master/#if), [switch](https://ziglang.org/documentation/master/#switch), [while](https://ziglang.org/documentation/master/#while), [for](https://ziglang.org/documentation/master/#for)
...
-   See also [enum](https://ziglang.org/documentation/master/#enum)
...
-   See also [errdefer](https://ziglang.org/documentation/master/#errdefer)
...
-   See also [Errors](https://ziglang.org/documentation/master/#Errors)
...
-   See also [for](https://ziglang.org/documentation/master/#for)
...
-   See also [if](https://ziglang.org/documentation/master/#if)
...
-   See also [inline while](https://ziglang.org/documentation/master/#inline-while), [inline for](https://ziglang.org/documentation/master/#inline-for), [Functions](https://ziglang.org/documentation/master/#Functions)
...
-   Using `await` on a function frame which hasn't completed yet results in safety-checked [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior).
-   Calling an async function may result in safety-checked [Illegal Behavior](https://ziglang.org/documentation/master/#Illegal-Behavior), because it's equivalent to `await async some_async_fn()`, which contains an `await`.

Code inside a `nosuspend` scope does not cause the enclosing function to become an [async function](https://ziglang.org/documentation/master/#Async-Functions).
...
-   See also [opaque](https://ziglang.org/documentation/master/#opaque)
...
-   See also [Optionals](https://ziglang.org/documentation/master/#Optionals), [Operators](https://ziglang.org/documentation/master/#Operators)
...
-   See also [packed struct](https://ziglang.org/documentation/master/#packed-struct)
...
-   See also [import](https://ziglang.org/documentation/master/#import)
...
-   See also [struct](https://ziglang.org/documentation/master/#struct)
...
A `switch` expression can be used to test values of a common type. `switch` cases can capture field values of a [Tagged union](https://ziglang.org/documentation/master/#Tagged-union).

-   See also [switch](https://ziglang.org/documentation/master/#switch)
...
-   See also [Zig Test](https://ziglang.org/documentation/master/#Zig-Test)
...
-   See also [Thread Local Variables](https://ziglang.org/documentation/master/#Thread-Local-Variables)
...
-   See also [try](https://ziglang.org/documentation/master/#try)
...
-   See also [union](https://ziglang.org/documentation/master/#union)
...
-   See also [unreachable](https://ziglang.org/documentation/master/#unreachable)
...
-   See also [volatile](https://ziglang.org/documentation/master/#volatile), [Assembly](https://ziglang.org/documentation/master/#Assembly)
...
### [Zen](https://ziglang.org/documentation/master/#toc-Zen) [§](https://ziglang.org/documentation/master/#Zen)
...
---
Source: [Documentation - The Zig Programming Language](https://ziglang.org/documentation/master/)